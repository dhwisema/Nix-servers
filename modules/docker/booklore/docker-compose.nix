...

{
  ...
  virtualisation.oci-containers.containers."booklore" = {
    ...
    environment = {
      ...
      "DB_PASSWORD" = "Procreate-Badass-Curse-Unearned7-Poise-Scribing";
      "GROUP_ID" = "0";
      "TZ" = "Etc/UTC";
      "USER_ID" = "0";
    };
    ...
    labels = {
      "compose2nix.settings.sops.secrets" = "DB_PASSWORD,MYSQL_ROOT_PASSWORD";
    };
    dependsOn = [
      "mariadb"
    ];
  ...
  virtualisation.oci-containers.containers."mariadb" = {
    ...
    environment = {
      ...
      MYSQL_ROOT_PASSWORD_FILE = config.sops.secrets."MYSQL_ROOT_PASSWORD".path;
      "PGID" = "1000";
      "PUID" = "1000";
      "TZ" = "Etc/UTC";
    };
    ...
    labels = {
      "compose2nix.settings.sops.secrets" = "MYSQL_ROOT_PASSWORD,DB_PASSWORD";
    };
    log-driver = "journald";
    extraOptions = [
