...

{
  ...
  virtualisation.oci-containers.containers."booklore" = {
    ...
    environment = {
      "BOOKLORE_PORT" = "6060";
      "DATABASE_PASSWORD" = "Procreate-Badass-Curse-Unearned7-Poise-Scribing";
  ...
  virtualisation.oci-containers.containers."mariadb" = {
    ...
    environment = {
      ...
      "MYSQL_PASSWORD" = "Procreate-Badass-Curse-Unearned7-Poise-Scribing";
      "MYSQL_ROOT_PASSWORD" = "Fabulous-Proponent-Subpanel-Excitable5-Monastery-Stained";
      "MYSQL_USER" = "booklore";
      "PGID" = "1000";
      "PUID" = "1000";
      "TZ" = "Etc/UTC";
